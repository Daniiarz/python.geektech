...
def check_win(x_or_o):
    for n in range(3):
        check_line(field[n][0], field[n][1], field[n][2], x_or_o)
        check_line(field[0][n], field[1][n], field[2][n], x_or_o)
    check_line(field[0][0], field[1][1], field[2][2], x_or_o)
    check_line(field[2][0], field[1][1], field[0][2], x_or_o)


def check_line(a1, a2, a3, x_or_o):
    if a1['text'] == x_or_o and a2['text'] == x_or_o and a3['text'] == x_or_o:
        a1['background'] = a2['background'] = a3['background'] = 'pink'
        global game_run
        game_run = False


def can_win(a1, a2, a3, x_or_o):
    res = False
    if a1['text'] == x_or_o and a2['text'] == x_or_o and a3['text'] == ' ':
        a3['text'] = 'O'
        res = True
    if a1['text'] == x_or_o and a2['text'] == ' ' and a3['text'] == x_or_o:
        a2['text'] = 'O'
        res = True
    if a1['text'] == ' ' and a2['text'] == x_or_o and a3['text'] == x_or_o:
        a1['text'] = 'O'
        res = True
    return res
